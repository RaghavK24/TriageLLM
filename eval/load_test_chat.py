"""
Load simulator for /chat only.

Fires N concurrent requests at ONLY /chat using the labeled prompt set,
measures latency and cost, and writes results to results/chat_<N>.json.

Run:
    python -m eval.load_test_chat --levels 5 15 30 50 --url http://localhost:8000
"""
